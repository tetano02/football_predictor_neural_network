...
for i in range(2013, 2023):
    ...
    actual_x = np.column_stack([data['Home Value Weight'], data['Medium Points Home'], data['Away Value Weight'], data['Medium Points Away']])
...
x_test = np.column_stack([data['Home Value Weight'].values, data['Medium Points Home'].values, data['Away Value Weight'].values, data['Medium Points Away'].values])
